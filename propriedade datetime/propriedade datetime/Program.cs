...
namespace propriedade_datetime {
    internal class Program {
        static void Main(string[] args) {
            ...
            DateTime z = new DateTime(2001, 8, 15, 13, 45, 58);
            string s1 = z.ToLongDateString();
            string s2 = z.ToLongTimeString();
            string s3 = z.ToShortDateString();
            string s4 = z.ToShortTimeString();
            string s5 = z.ToString();
            string s6 = z.ToString("yyyy-MM-dd HH:mm:ss");
            string s7 = z.ToString("yyyy-MM-dd HH:mm:ss.fff");
